...
class Artwork_Grid_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls(): void {
		...
		$this->start_controls_section(
			'section_filter',
			[
				'label' => esc_html__( 'Category Filter', 'galerie-mueller-widgets' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'show_filter',
			[
				'label'        => esc_html__( 'Enable Category Filter', 'galerie-mueller-widgets' ),
				'type'         => \Elementor\Controls_Manager::SWITCHER,
		...
		$this->start_controls_section(
			'style_filter',
			[
				'label'     => esc_html__( 'Filter Categories', 'galerie-mueller-widgets' ),
				'tab'       => \Elementor\Controls_Manager::TAB_STYLE,
				'condition' => [ 'show_filter' => 'yes' ],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'default'   => 'center',
				'selectors' => [
					'{{WRAPPER}} .gm-artwork-grid__filters' => 'justify-content: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .gm-artwork-grid__filter-btn',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#6B6B6B',
				'selectors' => [
					'{{WRAPPER}} .gm-artwork-grid__filter-btn' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->start_controls_tab(
			'filter_hover',
			[
				'label' => esc_html__( 'Hover/Active', 'galerie-mueller-widgets' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#1A1A1A',
				'selectors' => [
					'{{WRAPPER}} .gm-artwork-grid__filter-btn:hover' => 'color: {{VALUE}};',
					'{{WRAPPER}} .gm-artwork-grid__filter-btn--active' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Active Border Color', 'galerie-mueller-widgets' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'default'   => '#8C7A5B',
				'selectors' => [
					'{{WRAPPER}} .gm-artwork-grid__filter-btn--active::after' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'filter_spacing',
			[
				'label'      => esc_html__( 'Spacing Below Filter', 'galerie-mueller-widgets' ),
				'type'       => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em' ],
				'range'      => [
					'px' => [ 'min' => 0, 'max' => 100 ],
				...
				'selectors'  => [
					'{{WRAPPER}} .gm-artwork-grid__filter-container' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
